<template>
   ...
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               ...
               <li class="active"><router-link to="">Страхование от несчастных случаев</router-link></li>
      ...
      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Insurance Accident</span>
            <h1 class="i-title section-title">Защита в случае несчастного случая</h1>
            <h4 class="i-subtitle">Финансовая помощь в связи с наступлением несчастного случая. Защитите себя и самых дорогих людей от негативных последствий несчастных случаев и получите достойную финансовую поддержку.</h4>
         
            <h3 class="static-md-title">Надежная комплексная защита на случай досадных, но вполне вероятных ситуаций в жизни</h3>
            
            <div class="descr-wrap">
               <div class="descr-block">
                  <p>Наша жизнь всегда полна неожиданными и спонтанными событиями. В жизни большинства из нас были моменты, которые меняли все, переворачивали всю жизнь, меняли судьбу и радикально влияли на будущее. Хорошие или плохие, счастливые или нет, эти внезапные события имеют одно незыблемое всеобщее — они всегда происходят неожиданно.</p>
               </div>
               <div class="descr-block">
                  <p>Мы не всегда можем это предотвратить, однако мы способны оградить себя и самых дорогих людей от негативных последствий несчастных случаев и обеспечить достойную финансовую поддержку. Обладая необходимыми средствами, любой человек может значительно улучшить свое здоровье, восстановить его, спасти свою жизнь.</p>
               </div>
               <div class="descr-block">
                  <p>Даже в условиях, когда возможности врачей и медицинских учреждений ограничены их материально-техническим обеспечением, Вы получаете страховую защиту, позволяющую спокойно строить планы на будущее, производить накопления.</p>
               </div>
               <div class="descr-block">
                  <p>МетЛайф, мировой лидер и компания, начавшая в истории пример массового страхования от несчастного случая, предлагает лучшие решения, которые оказывают надежную страховую защиту от любого негативного внешнего воздействия, и помогают в решении финансовых проблем, связанных с ухудшением состояния здоровья. я, болезнями и их лечением, сохраняя при этом привычный уровень жизни и компенсируя затраты на лечение клиента.</p>
               </div>
            </div>
            ...
            <div class="navigate-block">
               <div class="navigate-row row">
                  <div class="col-6 navigate-col">
                     <router-link to="program-pi" class="navigate-link">
                        <div class="watermark">01</div>
                        <h3>Программа страхования PI</h3>
                        <p>Постоянная нетрудоспособность в результате несчастного случая</p>
                     </router-link>
                  </div>
                  <div class="col-6 navigate-col">
                     <router-link to="program-pi-traffic" class="navigate-link">
                        <div class="watermark">02</div>
                        <h3>Программа страхования PI traffic</h3>
                        <p>Постоянная нетрудоспособность в результате несчастного случая на транспорте</p>
                     </router-link>
                  </div>
                  <div class="col-6 navigate-col">
                     <router-link to="program-bob" class="navigate-link">
                        <div class="watermark">03</div>
                        <h3>Программа страхования BOB</h3>
                        <p>Переломы и/или ожоги в результате несчастного случая</p>
                     </router-link>
                  </div>
                  <div class="col-6 navigate-col">
                     <router-link to="program-bi" class="navigate-link">
                        <div class="watermark">04</div>
                        <h3>Программа страхования BI</h3>
                        <p>Телесные повреждения в результате несчастного случая</p>
                     </router-link>
                  </div>
               </div>
            </div>
...
@Component
export default class PageInsuranceAccidentComponents extends Vue {  // Страница - Страхование от несчастных случаев
