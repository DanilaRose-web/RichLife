<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               <li><router-link to="program-pi">Программа страхования PI</router-link></li>
               <li class="active"><router-link to="program-pi-traffic">Программа страхования PI traffic</router-link></li>
               <li><router-link to="program-bob">Программа страхования BOB</router-link></li>
               <li><router-link to="program-bi">Программа страхования BI</router-link></li>
            </ul>
         </services-static-menu> -->
      </template>
      ...
      <breadcrumbs>
         ...
         <router-link to="insurance-for-me">Страхование от несчастных случаев <svg><use xlink:href="/assets/img/svg-sprite.svg#arrows-breadcrumb"></use></svg></router-link>
         <span>Программа страхования PI traffic</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program PI traffic</span>
            <h1 class="i-title section-title">Постоянная нетрудоспособность – НД на транспорте</h1>
            <h4 class="i-subtitle">Несчастный случай – это случайные, внешние, насильственные, внезапные, не вызванные преднамеренно события, произошедшие в течение срока действия Договора Страхование и причинившие тяжкое телесное повреждение или травму нуждается в госпитализации.</h4>

            <div class="descr-wrap">
               <h4>Постоянная нетрудоспособность в результате несчастного случая</h4>
               ...
               <div class="descr-block">
                  ...
                  <p>Если PI Traffic выбран из программы страхования основных рисков E, PEAD (п. 4.1. заявления о страховании), минимальная страховая премия по PI Traffic рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 4000 грн., из которых минимум 30% по программам страхования дополнительных рисков. Если PI Traffic выбрана из программы страхования основных рисков TERM со страховой суммой 50 грн. (п. 4.2. заявления о страховании), минимальная страховая премия по PI Traffic рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 500 грн. для взрослых, 400 грн. для детей и 250 грн. при групповом страховании.</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>Если PI Traffic выбрана из программы страхования основных рисков E, PEAD (п. 4.1. заявления о страховании), то страховая сумма по ней должна быть равна или превышать страховую сумму по программе страхования основных рисков. Если PI Traffic выбран из программы страхования основных рисков TERM со страховой суммой 50 грн. (п. 4.2. заявления о страховании), минимальная страховая сумма по ней составляет 50 000 грн.</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>Применяется кроме случаев, когда PI Traffic покупается с программой страхования основных рисков TERM, выбранной в п.4.1. заявления о страховании</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageProgramPiTrafficComponents extends Vue {  // Страница - Копмплексные программы накопления
