<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               ...
               <li><router-link to="program-pi-traffic">Программа страхования PI traffic</router-link></li>
               <li><router-link to="program-bob">Программа страхования BOB</router-link></li>
               <li class="active"><router-link to="program-bi">Программа страхования BI</router-link></li>
            </ul>
         </services-static-menu> -->
      </template>
      ...
      <breadcrumbs>
         ...
         <span>Программа страхования BI</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program Bi</span>
            <h1 class="i-title section-title">Телесные повреждения в результате несчастного случая</h1>
            ...
            <div class="descr-wrap">
               <h4>Телесные повреждения в результате несчастного случая</h4>
               ...
               <div class="descr-block">
                  ...
                  <p>Если ВИ выбрана с программой страхования основных рисков E, PEAD (п. 4.1. заявления о страховании), минимальная страховая премия по ВИ рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 4 000 грн., из которых минимум 30% по программам страхования дополнительных рисков. Если Вы выбрано с программой страхования основных рисков TERM со страховой суммой 50 грн. (п. 4.2. заявления о страховании), минимальная страховая премия по ВИ рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 500 грн. для взрослых, 400 грн. для детей и 250 грн. при групповом страховании.</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>Применяется кроме случаев, когда ВИ покупается с программой страхования основных рисков TERM, избранной в п.4.1. заявления о страховании</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageProgramBobComponents extends Vue {  // Страница - Копмплексные программы накопления
