<template>
   ...
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               ...
               <li class="active"><router-link to="womens-insurance">Женское страхование</router-link></li>
            </ul>
         </services-static-menu> -->
      </template>
      ...
      <breadcrumbs>
         ...
         <span>Женское страхование</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Women's Insurance</span>
            <h1 class="i-title section-title">Защита для женщин при серьезной болезни</h1>
            <h4 class="i-subtitle">Полноценная финансовая поддержка при постановке онко-диагноза при заболевании женских органов и при критических женских рисках.</h4>
         
            <h3 class="static-md-title">Финансовая помощь при серьезной болезни у женщин</h3>
            
            <div class="descr-wrap">
               <div class="descr-block">
                  <p>Одной из ключевых проблем, с которой сталкиваются женщины в процессе лечения – доступ к лечению. К сожалению, современные методы лечения редко могут на 100% обеспечить женщину в рамках существующей системы государственного бесплатного здравоохранения в Украине. Поэтому пациенткам и их близким часто приходится прибегать к поиску дополнительных финансовых средств для получения доступа к современной и высокоэффективной медицинской помощи. Финансовая поддержка является важным условием для успешного лечения и выздоровления, ведь чтобы победить болезнь, лечение должно быть своевременным и эффективным.</p>
               </div>
               <div class="descr-block">
                  <p>Компания "МетЛайф" дает возможность каждой украинской женщине от 18 до 60 лет получить гарантии полноценной финансовой поддержки в случае постановки онко-диагноза при заболевании женских органов и критических женских рисков. Такой финансовой защитой за последние 2 года воспользовались более 70 000 украинок, а компания поддержала более 20 инициатив по информированию женщин о профилактике рака женских органов, его современном лечении и реабилитации после заболевания.</p>
               </div>
            </div>
            ...
            <div class="navigate-block">
               <div class="navigate-row row">
                  <div class="col-6 navigate-col">
                     <router-link to="program-fc" class="navigate-link">
                        <div class="watermark">01</div>
                        <h3>Программа страхования FC</h3>
                        <p>Страхование на случай диагностики рака женского органа и госпитализации в связи с раком женского органа</p>
                     </router-link>
                  </div>
                  <div class="col-6 navigate-col">
                     <router-link to="program-cfb" class="navigate-link">
                        <div class="watermark">02</div>
                        <h3>Программа страхования CFB</h3>
                        <p>Страхование на случай критических женских рисков</p>
                     </router-link>
                  </div>
               </div>
            </div>
...
@Component
export default class PageWomensInsuranceComponents extends Vue {  // Страница - женское страхование
