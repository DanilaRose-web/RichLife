<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               <li class="active"><router-link to="program-c-1">Программа страхования СИ-1</router-link></li>
      ...
      <breadcrumbs>
         ...
         <span>Программа страхования СИ-1</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program C-1</span>
            <h1 class="i-title section-title">Диагностирование критического заболевания</h1>
