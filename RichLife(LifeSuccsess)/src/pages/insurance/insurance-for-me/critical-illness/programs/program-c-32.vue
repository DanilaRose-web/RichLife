<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               ...
               <li class="active"><router-link to="program-c-32">Программа страхования СИ-32</router-link></li>
               <li><router-link to="program-w">Программа страхования W</router-link></li>
            </ul>
         </services-static-menu> -->
      </template>
      ...
      <breadcrumbs>
         ...
         <span>Программа страхования СИ-32</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program C-32</span>
            <h1 class="i-title section-title">Диагностирование 1 из 32 критических заболеваний</h1>
            <h4 class="i-subtitle">Обладая необходимыми средствами, любой человек может значительно улучшить свое здоОбладая необходимыми средствами, любой человек может значительно улучшить свое здоровье, восстановить его, спасти свою жизнь. Компания МетЛайф предлагает уникальные возможности для решения финансовых проблем в случае игнорирования серьезной болезни, которые помогут сохранить Ваш привычный уровень жизни.</h4>

            <div class="descr-wrap">
               <h4>Страхование на случай диагностирования у Застрахованного Лица критического заболевания</h4>
               <h4>Болезни / состояния:</h4>
               <div class="descr-block">
                  <h4>Болезни/состояния</h4>
                  <ul class="i-ul-list descr-list mt">
                     <li>Рак</li>
                     <li>Инфаркт миокарда</li>
                     <li>Инсульт</li>
                     <li>Операция на клапане сердца</li>
                     <li>Операция на аорте</li>
                     <li>Заболевание коронарных артерий сердца, требующее шунтирования</li>
                     <li>Другие тяжелые заболевания коронарных артерий</li>
                     <li>Слепота (потеря зрения)</li>
                     <li>Глухота (утрата слуха)</li>
                     <li>Потеря языка</li>
                     <li>Кома</li>
                     <li>Большие ожоги</li>
                     <li>Почечная недостаточность</li>
                     <li>Необходимость в трансплантации жизненно важного органа</li>
                     <li>Апластическая анемия</li>
                     <li>Терминальная стадия заболевания легких</li>
                     <li>Терминальная стадия печеночной недостаточности</li>
                     <li>Рассеянный склероз</li>
                     <li>Паралич (утрата функций конечностей)</li>
                     <li>Болезнь Паркинсона</li>
                     <li>Болезнь Альцгеймера (тяжелая деменция) (до 60 лет)</li>
                     <li>Фульминантный гепатит</li>
                     <li>Первичная легочная гипертензия</li>
                     <li>Смертельная неизлечимая болезнь</li>
                     <li>Доброкачественная опухоль мозга</li>
                     <li>Энцефалит</li>
                     <li>Полиомиелит</li>
                     <li>Бактериальный менингит</li>
                     <li>Тяжелая травма головы</li>
                     <li>Апалический синдром</li>
                     <li>Прогрессирующая склеродермия</li>
                     <li>Системная красная волчанка с люпус-нефритом</li>
                  </ul>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>На 1 год/На 5 лет/На 10 лет/До 65 лет</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>Если CI выбрана из программы страхования основных рисков E, PEAD (п. 4.1. заявления о страховании), минимальная страховая премия по CI рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 4 000 грн., из которых минимум 30% по программам страхования дополнительных рисков. Если CI выбрана из программы страхования основных рисков TERM со страховой суммой 50 грн. (п. 4.2. заявления о страховании), минимальная страховая премия по CI рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 500 грн. и 250 грн. при групповом страховании.Если </p>
               </div>
               <div class="descr-block">
                  <h4>Максимальная страховая премия</h4>
                  <p>Рассчитывается согласно максимальному размеру страховой суммы, установленной для данной программы</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageProgramC32Components extends Vue {  // Страница - Копмплексные программы накопления
