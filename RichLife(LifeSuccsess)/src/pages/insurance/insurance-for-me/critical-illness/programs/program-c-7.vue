<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               ...
               <li class="active"><router-link to="program-c-7">Программа страхования СИ-7</router-link></li>
      ...
      <breadcrumbs>
         ...
         <span>Программа страхования СИ-7</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program C-7</span>
            <h1 class="i-title section-title">Диагностирование 1 из 7 критических заболеваний</h1>
            ...
            <div class="descr-wrap">
               ...
               <div class="descr-block">
                  ...
                  <ul class="i-ul-list descr-list mt">
                     ...
                     <li>Необходимость трансплантации жизненно важного органа</li>
...
@Component
export default class PageProgramC7Components extends Vue {  // Страница - Копмплексные программы накопления
