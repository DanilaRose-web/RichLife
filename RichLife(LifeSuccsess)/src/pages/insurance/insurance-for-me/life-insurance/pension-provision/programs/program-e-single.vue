<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      ...
      <breadcrumbs>
         ...
         <span>Смерть или дожитие с оплатой единовременной премии</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Death or Survival</span>
            <h1 class="i-title section-title">Смерть или дожитие с оплатой единовременной премии</h1>
            ...
            <div class="descr-wrap">
               <h4>Страхование на случай смерти или дожития с возможностью оплаты единовременной страховой премии</h4>
               ...
               <div class="descr-block">
                  ...
                  <p>На срок: 10, 15, 20, 25 лет</p>
                  <p>До достижения возраста: 50, 55, 60, 65 лет</p>
               </div>
               <div class="descr-block">
                  <h4>Минимальный размер Страховой премии</h4>
                  <p>5 000 грн. для клиентов, которые реинвестируют свою страховую выплату из жизни от ЧАО "МетЛайф"</p>
                  <p>50 000 грн. для новых клиентов ЧАО "МетЛайф"</p>
               </div>
               <div class="descr-block">
                  <h4>Максимальный размер Страховой Премии</h4>
                  <p>Не ограничен</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageProgramESingleComponents extends Vue {  // Страница - Копмплексные программы накопления
