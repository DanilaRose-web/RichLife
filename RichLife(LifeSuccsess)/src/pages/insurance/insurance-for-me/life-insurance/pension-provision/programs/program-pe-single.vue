<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      ...
      <breadcrumbs>
         ...
         <span>Дожитие до определенного возраста с одноразовой оплатой</span>
      </breadcrumbs>
      ...
      <section class="section-main i-section">
         <i-container>
            ...
            <div class="descr-wrap">
               <h4>Страхование на случай дожития до определенного возраста или на определенный срок с возможностью уплаты единовременной страховой премии</h4>
