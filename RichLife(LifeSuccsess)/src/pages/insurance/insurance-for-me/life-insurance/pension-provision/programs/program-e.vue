<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      ...
      <breadcrumbs>
         ...
         <span>Страхование на случай смерти или дожития</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Death or Survival</span>
            <h1 class="i-title section-title">Страхование на случай смерти или дожития</h1>
            ...
            <div class="descr-wrap">
               <h4>Страхование на случай смерти или дожития</h4>
               ...
               <div class="descr-block">
                  ...
                  <p>На срок: 10, 15, 16, 17, 18, 19, 20, 25 лет</p>
                  <p>До достижения возраста: 50, 55, 60, 65, 75 лет</p>
               </div>
               <div class="descr-block">
                  <h4>Минимальная страховая премия</h4>
                  <p>Если 2500 грн. по программе E. При этом общая страховая премия по пакету должна составлять минимум 4000 грн., из которых минимум 30% по программам страхования дополнительных рисков.</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageProgramEComponents extends Vue {  // Страница - Копмплексные программы накопления
