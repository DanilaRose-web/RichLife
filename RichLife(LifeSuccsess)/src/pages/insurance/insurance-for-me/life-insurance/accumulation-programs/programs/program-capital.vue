<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      ...
      <breadcrumbs>
         ...
         <span>Пакет "Капитал" для достойной жизни на пенсии</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Capital</span>
            <h1 class="i-title section-title">Пакет "Капитал" для достойной жизни на пенсии</h1>
               ...
               <div class="table-content">
                  ...
                  <div class="table-block">
                     <div class="table-block-item">
                        ...
                        <div class="table-row">
                           <h6 class="table-flex-title center sm">PEAD</h6>
               ...
               <div class="table-content">
                  ...
                  <div class="table-block">
                     ...
                     <div class="table-block-item">
                        ...
                        <div class="table-row">
                           <h6 class="table-flex-title center sm">2PI</h6>
                           <p>Страхование на случай постоянной нетрудоспособности в результате несчастного случая</p>
                        </div>
                        <div class="table-row">
                           <h6 class="table-flex-title center sm">H/S/Ca</h6>
                           <p>Страхование на случай хирургического вмешательства и/или госпитализации в результате несчастного случая</p>
                        </div>
                        <div class="table-row">
                           <h6 class="table-flex-title center sm">CFB</h6>
                           <p>Страхование на случай критических женских рисков – для женщин</p>
                        </div>
                        <div class="table-row">
            ...
            <div class="descr-wrap">
               ...
               <div class="descr-block">
                  <h4>Страховая сумма для мужчин</h4>
                  <p>PEAD – не ограничен (зависит от пола, возраста, служебных обязанностей Застрахованного Лица, срока страхования и размера страховой премии)</p>
                  <p>PI = страховая сумма по E*2</p>
                  <p>H/S/Ca – 150 грн/15 000 грн/75 грн.</p>
                  <p>BI – 15 000 грн.</p>
               ...
               <div class="descr-block">
                  ...
                  <p>применяется (кроме ВОВ (акция))</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageProgramCapitalComponents extends Vue {  // Страница - Копмплексные программы накопления
