<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               <li class="active"><router-link to="program-child-pead">Программа страхования PEAD</router-link></li>
               <li><router-link to="program-child-pe-single">Программа страхования PE Single</router-link></li>
            </ul>
         </services-static-menu> -->
      </template>
      ...
      <breadcrumbs>
         ...
         <span>Программа страхования PEAD</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program PEAD</span>
            <h1 class="i-title section-title">Дожитие до определенного возраста</h1>
            ...
            <div class="descr-wrap">
               ...
               <div class="descr-block">
                  ...
                  <p>До достижения возраста 16, 17, 18, 21, 24, 25, 27 лет сроком 10, 15, 20, 25 лет</p>
               </div>
               <div class="descr-block">
                  <h4>Вводный возраст</h4>
                  <p>От 18 до 65 лет</p>
               ...
               <div class="descr-block">
                  <h4>Период страхования</h4>
                  <p>Сроком 10, 15, 20, 25 лет</p>
                  <p>До достижения возраста 16, 17, 18, 21, 24, 25, 27 лет</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageProgramChildPeadComponents extends Vue {  // Страница - 
