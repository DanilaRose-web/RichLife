<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
        ...
        <minimal-header-metlife @getInTouch="onGetInTouch" @openNote="openNoteModal" @changeShow="onChangeShow" :innerShowMenu="innerShowMenu" @callUs="onCallUs" class="static" @showJoinModal="onShowJoinModal" @showGetInTouch="onGetInTouch" />
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               <li><router-link to="program-child-pead">Программа страхования PEAD</router-link></li>
               <li class="active"><router-link to="program-child-pe-single">Программа страхования PE Single</router-link></li>
            </ul>
         </services-static-menu> -->
      </template>
      ...
      <breadcrumbs>
         ...
         <router-link to="capital-for-children">Накопление капитала для детей <svg><use xlink:href="/assets/img/svg-sprite.svg#arrows-breadcrumb"></use></svg></router-link>
         <span>Программа страхования PE Single</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program PE Single</span>
            <h1 class="i-title section-title">Дожитие до определенного возраста с одноразовой оплатой</h1>
            <h4 class="i-subtitle">Компания «МетЛайф» предлагает действенные варианты накопления капитала для ребенка на обучение и старту взрослой жизни с возможностью получения выплаты по истечении срока накопления</h4>

            <div class="descr-wrap">
               <h4>Страхование на случай доживания до определенного возраста или на определенный срок с возможностью уплаты единовременной страховой премии</h4>
               <div class="descr-block">
                  <h4>Вводный возраст</h4>
                  <p>от 0 до 17 лет</p>
               </div>
               <div class="descr-block">
                  <h4>Максимальный возраст на дату окончания действия программы</h4>
                  <p>27 лет</p>
               </div>
               <div class="descr-block">
                  <h4>Период страхования</h4>
                  <p>Срок 10, 15, 20 лет</p>
                  <p>До достижения возраста 16, 17, 18, 21, 24, 25 лет</p>
               </div>
               <div class="descr-block">
                  <h4>Минимальный размер Страховой премии</h4>
                  <p>15 000 грн. для клиентов, которые реинвестируют свою страховую выплату из жизни от ЧАО "МетЛайф"</p>
                  <p>50 000 грн. для новых клиентов ЧАО "МетЛайф"</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageProgramChildPeSingleComponents extends Vue {  // Страница - 
