<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               <li class="active"><router-link to="childhood-critical-illness">Детское страхование от критических заболеваний</router-link></li>
               <li><router-link to="loss-of-breadwinner">Страхование в случае потери кормильца</router-link></li>
               <li><router-link to="capital-of-children">Накопление капитала для детей</router-link></li>
      ...
      <breadcrumbs>
         ...
         <span>Детское страхование от критических заболеваний</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Childhood Critical Illness</span>
            <h1 class="i-title section-title">Защита при серьезной болезни для детей</h1>
            <h4 class="i-subtitle">Финансовая помощь при серьезной болезни – уникальные возможности для решения финансовых проблем в случае даигностирования серьезной болезни, которые помогут сохранить Ваш привычный уровень жизни.</h4>

            <div class="descr-wrap">
               <h4>Страхование на случай критического заболевания ребенка</h4>
               <div class="descr-block">
                  <h4>Заболевания/состояния, покрываемые данной программой</h4>
                  <p>Рак; Апластическая анемия; Менингит; Глухота (потеря слуха); Доброкачественная опухоль головного мозга; Острая ревматическая лихорадка; хронический активный вирусный гепатит; Инфицирование ВИЧ при переливании крови; Паралич; полиомиелит; Почечная недостаточность; Сахарный диабет; Приобретены хронические заболевания сердца; Столбняк; Слепота (потеря зрения); Трансплантация жизненно важных органов (КМ); Хирургическое лечение заболеваний аорты; Хирургическое вмешательство на сердечный клапан; Эпилепсия; Энцефалит. </p>
               </div>
               <div class="descr-block">
                  <h4>Вступительный возраст</h4>
                  <p>От 3 месяцев до 17 лет</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>Если JCI 20 выбран из программы страхования основных рисков PEAD (п. 4.1. заявления о страховании), минимальная страховая премия по JCI 20 рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 4 000 грн., из которых минимум 30% по программам страхования дополнительных рисков. Если JCI 20 выбран из программы страхования основных рисков TERM со страховой суммой 50 грн. (п. 4.2. заявления о страховании), минимальная страховая премия по JCI 20 рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 400 грн. и 250 грн. при групповом страховании.</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageChildhoodCriticalIllnessComponents extends Vue {  // Страница - Копмплексные программы накопления
