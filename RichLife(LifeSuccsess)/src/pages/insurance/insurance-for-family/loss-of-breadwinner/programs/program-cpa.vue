<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               ...
               <li class="active"><router-link to="program-cpa">Программа страхования CPA</router-link></li>
            </ul>
         </services-static-menu> -->
      </template>
      ...
      <breadcrumbs>
         ...
         <span>Программа страхования CPA</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program CPA</span>
            <h1 class="i-title section-title">Смерть или постоянная и полная нетрудоспособность</h1>
            ...
            <div class="descr-wrap">
               <h4>Страхование на случай смерти или постоянной и полной нетрудоспособности страхователя (освобождение от уплаты страховых премий) по детской программе накопления</h4>
               <div class="descr-block">
                  <h4>Вступительный возраст</h4>
                  <p>Для взрослых от 18 до 55 лет</p>
                  <p>Для детей от 0 до 16 лет</p>
               </div>
               <div class="descr-block">
                  <h4>Максимальный возраст на дату окончания программы</h4>
                  <p>Для взрослых 60 лет</p>
                  <p>Для детей 21 год</p>
               </div>
               <div class="descr-block">
...
@Component
export default class PageProgramCpaComponents extends Vue {  // Страница - 
