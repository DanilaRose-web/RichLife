<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
      <template slot="header">
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               ...
               <li class="active"><router-link to="program-adob">Программа страхования ADob</router-link></li>
      ...
      <breadcrumbs>
         ...
         <span>Программа страхования ADob</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program ADob</span>
            <h1 class="i-title section-title">Смерть в результате несчастного случаястного случая</h1>
            ...
            <div class="descr-wrap">
               <h4>Страхование на случай смерти в результате несчастного случая с выплатой дополнительной страховой суммы на случай сиротства</h4>
               ...
               <div class="descr-block">
                  ...
                  <p>Если ADob выбран из программы страхования основных рисков E, PEAD (п. 4.1. заявления о страховании), минимальная страховая премия по ADob рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 4 000 грн., из которых минимум 30% по программам страхования дополнительных рисков. Если ADob выбран из программы страхования основных рисков TERM со страховой суммой 50 грн. (п. 4.2. заявления о страховании), минимальная страховая премия по ADob рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 500 грн. и 250 грн. – при групповом страховании.</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>Если ADob выбран с программой страхования основных рисков E, PEAD (п. 4.1. заявления о страховании), то страховая сумма по ней должна быть равна или превышать страховую сумму по программе страхования основных рисков. Если ADob выбран из программы страхования основных рисков TERM со страховой суммой 50 грн. (п. 4.2. заявления о страховании), минимальная страховая сумма по ней составляет 50 000 грн.</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>Применяется кроме случаев, когда ADob покупается с программой страхования основных рисков TERM, выбранной в п.4.1. заявления о страховании</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>По заявлению Страхователя после формирования выкупной суммы по программе страхования основных рисков (если программа входит в состав договора страхования, заключаемого в соответствии с разделом 4.1. заявления о страховании)</p>
               </div>
               <div class="descr-block">
                  <h4>Налоговая скидка</h4>
                  <p>Может быть получена на сумму страховой премии по этой программе (если программа входит в состав договора страхования, заключаемого в соответствии с разделом 4.1. заявления о страховании)</p>
               </div>
            </div>
         </i-container>
      </section>
...
@Component
export default class PageProgramAdobComponents extends Vue {  // Страница - 
