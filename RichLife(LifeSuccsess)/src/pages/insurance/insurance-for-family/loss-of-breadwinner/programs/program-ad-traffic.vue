<template>
   <layout @showJoinModalFooter="onShowJoinModalFooter" @getInTouch="onGetInTouch">
        ...
        <minimal-header-metlife @getInTouch="onGetInTouch" @openNote="openNoteModal" @changeShow="onChangeShow" :innerShowMenu="innerShowMenu" @callUs="onCallUs" class="static" @showJoinModal="onShowJoinModal" @showGetInTouch="onGetInTouch" />
         ...
         <!-- <services-static-menu>
            <ul class="static-menu">
               <li><router-link to="program-term">Программа страхования TERM</router-link></li>
               <li><router-link to="program-adob">Программа страхования ADob</router-link></li>
               <li class="active"><router-link to="program-ad-traffic">Программа страхования AD Traffic</router-link></li>
      ...
      <breadcrumbs>
         ...
         <span>Программа страхования AD Traffic</span>
      </breadcrumbs>

      <section class="section-main i-section">
         <i-container>
            <span class="i-title dancing">Program AD Traffic</span>
            <h1 class="i-title section-title">Смерть из-за несчастного случая на транспорте</h1>
            ...
            <div class="descr-wrap">
               <h4>Страхование на случай смерти в результате несчастного случая на транспорте</h4>
               ...
               <div class="descr-block">
                  ...
                  <p>Если AD Traffic выбран из программы страхования основных рисков E, PEAD (п. 4.1. заявления о страховании), минимальная страховая премия по AD Traffic рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 4000 грн., из которых минимум 30% по программам страхования дополнительных рисков. Если AD Traffic выбрана из программы страхования основных рисков TERM со страховой суммой 50 грн. (п. 4.2. заявления о страховании), минимальная страховая премия по AD Traffic рассчитывается в соответствии с установленным минимальным размером страховой суммы для данной программы, а минимальная страховая премия по пакету составляет 500 грн. и 250 грн. при групповом страховании.</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>Если AD Traffic выбрана из программы страхования основных рисков E, PEAD (п. 4.1. заявления о страховании), то страховая сумма по ней должна быть равна или превышать страховую сумму по программе страхования основных рисков. Если AD Traffic выбрана с программой страхования основных рисков TERM со страховой суммой 50 грн. (п. 4.2. заявления о страховании), минимальная страховая сумма по ней составляет 50 000 грн.</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>Применяется кроме случаев, когда AD Traffic покупается с программой страхования основных рисков TERM, выбранной в п.4.1. заявления о страховании</p>
               </div>
               <div class="descr-block">
               ...
               <div class="descr-block">
                  ...
                  <p>По заявлению Страхователя после формирования выкупной суммы по программе страхования основных рисков (если AD Traffic входит в состав договора страхования, заключаемого в соответствии с разделом 4.1. заявления о страховании)</p>
               </div>
               <div class="descr-block">
                  <h4>Налоговая скидка</h4>
                  <p>Может быть получена на сумму страховой премии по этой программе (если AD Traffic входит в состав договора страхования, заключаемого в соответствии с разделом 4.1. заявления о страховании)</p>
               </div>
            </div>
         </i-container>
      </section>
...
@Component
export default class PageProgramAdTrafficComponents extends Vue {  // Страница - 
