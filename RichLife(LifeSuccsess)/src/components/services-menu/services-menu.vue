   ...
   <nav>
      <i-container class="services-menu-container" :display="'flex'" :align="'center'" :justify="justify">
         ...
         <ul class="services-menu">
            <li @click="gotoMetLife">
               <router-link to="metlife">MetLife</router-link>
               <!-- <router-link to="insurance-for-me">Страхование для меня</router-link>
            ...
            <li @click="gotoUniqa">
               <router-link to="uniqa">UNIQA</router-link>
            ...
            <!-- <li @click="gotoGrawe">
               <router-link to="grawe">GRAWE</router-link>
            ...
            <!-- <li @click="gotoTaslife">
               <router-link to="taslife">TASlife</router-link>
               ...
               <ul class="services-submenu">
                  ...
                  <li @click="gotoRules"><router-link to="insurance-rules"><img src="/assets/img/services-menu/icon19.svg" alt="Правила страхования"> <span>Правила страхования</span></router-link></li>
...
@Component
export default class ServicesMenuComponent extends Vue {
